						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Description-->
									<small class="text-muted fs-7 fw-bold my-1 ms-1">Muncha IT Department</small>
									<!--end::Description--></h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
									...
									<div class="col-xl-4">
										...
										<div class="card card-xl-stretch">
											...
											<div class="card-header border-0 bg-danger py-5">
												<h3 class="card-title fw-bolder text-white">Project Statistics</h3>
												<div class="card-toolbar">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">Time</div>
														</div>
														<!--end::Heading-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
												...
												<div class="card-p mt-n20 position-relative">
													...
													<div class="row g-0">
														...
														<div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-warning fw-bold fs-6">Weekly Project review</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
													...
													<div class="row g-0">
														...
														<div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-danger fw-bold fs-6 mt-2">Running project</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
										...
										<div class="card card-xl-stretch-50 mb-5 mb-xl-8">
											...
											<div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
												...
												<div class="d-flex flex-stack flex-wrap flex-grow-1 px-9 pt-9 pb-3">
													<div class="me-2">
														<span class="fw-bolder text-gray-800 d-block fs-3">Project progress</span>
														<span class="text-gray-400 fw-bold">Oct 8 - Oct 26 22</span>
													</div>
													<div class="fw-bolder fs-3 text-primary">50%</div>
												</div>
												<!--end::Hidden-->
												<!--begin::Chart-->
									...
									<div class="col-xl-8">
										...
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bolder fs-3 mb-1">Members Involved</span>
													<span class="text-muted mt-1 fw-bold fs-7">Over 5 members</span>
												</h3>
