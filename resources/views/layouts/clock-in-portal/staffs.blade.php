						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<a href="../../demo1/dist/.html" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Add staff</a>
									<!--end::Primary button-->
								</div>
								<!--end::Actions-->
							</div>
									...
									<div class="card-header align-items-center py-5 gap-2 gap-md-5">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<input type="text" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search for a staff" />
											</div>
											<!--end::Search-->
										</div>
										<!--end::Card title-->
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
											...
											<thead>
												...
												<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-175px">Staff name</th>
											...
											<tbody class="fw-bold text-gray-600">
												...
												<tr>
													...
													<td class="d-flex align-items-left">
														<span class="text-gray-500 text-hover-primary fs-5 ">Flutter developer</span>
													</td>
													<!--end::Date Added=-->
													<!--begin::Date Modified=-->
													<td>
														<div class="d-flex align-items-left">
																<a class="text-gray-500 text-hover-primary fs-5">Staff</a>
														</div>
													</td>
													<!--end::Date Modified=-->
													<!--begin::Action=-->
												...
												<tr>
													...
													<!--begin::Date Added=-->
													<td class="d-flex align-items-left">
														<span class="text-gray-500 text-hover-primary fs-5 ">Web developer</span>
													</td>
													<!--end::Date Added=-->
													<!--begin::Date Modified=-->
													<td>
												...
												<tr>
													...
													<td>
														<div class="d-flex align-items-left">
																<!--begin::Title-->
																<a class="text-gray-500 text-hover-primary fs-5 ">Rajan Shrestha</a>
																<!--end::Title-->
														</div>
													</td>
													<!--end::Customer=-->
													<!--begin::Date Added=-->
													<td class="d-flex align-items-left">
														<span class="text-gray-500 text-hover-primary fs-5 ">Manager</span>
													</td>
													<!--end::Date Added=-->
													<!--begin::Date Modified=-->
													<td>
														<div class="d-flex align-items-left">
																<a class="text-gray-500 text-hover-primary fs-5">Admin</a>
														</div>
													</td>
													<!--end::Date Modified=-->
													<!--begin::Action=-->
